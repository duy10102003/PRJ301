...
<section id="aa-catg-head-banner">
    <img src="${pageContext.request.contextPath}/view/client/assets/images/bannerpro.jpg" alt="banner sản phẩm">
...
<section id="aa-product-category">
                            ...
                            <c:forEach  items="${productlist}" var="product">
                                <li>
                                    <figure>
                                        ...
                                        <figcaption>
                                            <h4 class="aa-product-title"><a href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}">${product.name}
                                                </a></h4>
    ...
    <!-- Paging -->
    <div id="page_id" class="page_main">  
        <ul class="page">
            <li class="page__btn"><span class="material-icons">chevron_left</span></li>
            <c:forEach begin="1" end="${endP}" var="i">
            <li class="page__numbers ${tag == i?"active":""}"><a  href="${pageContext.request.contextPath}/view/client/product?index=${i}">${i}</a></li>     
            </c:forEach>
