      ...
      <div id="sequence" class="seq">
        <div class="seq-screen">
          <ul class="seq-canvas">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="${url}/images/cacloaihat.jpg" alt="Men slide img" />
              </div>
              <div class="seq-title">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="${url}/images/raucu.jpg" alt="Wristwatch slide img" />
              </div>
              <div class="seq-title">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="${url}/images/hoaqua.jpg" alt="Women Jeans slide img" />
              </div>
              <div class="seq-title">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="${url}/images/matong.jpg" alt="Shoes slide img" />
              </div>
              <div class="seq-title">
